...
Over de concepten van Artificiële Intelligentie (AI) en Large Language Models (LLMs) zal er nu nog niet verder worden uitweiden. Eerst een toespitsing op Agents.
...
Hier zien we een uit gezoomd kijk op de verschillende aspecten binnen dit onderzoek. Code voor het genereren van de mindmap\footnote{\href{https://latex-cookbook.net/mindmap/}{https://latex-cookbook.net/mindmap/}} verkregen van: \autocite{Kottwitz2024}
