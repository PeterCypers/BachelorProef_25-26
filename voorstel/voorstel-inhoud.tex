...
De \textbf{onderzoeksvraag} vanuit mijn stagebedrijf IT1 luidt als volgt: 
...
\begin{enumerate}
    ...
    We verbeteren de schaalbaarheid door van de API een gelaagd systeem te maken dat bestaat uit hiërarchisch lagen van componenten of services, elke component "ziet" niet verder dan de lagen waarmee die direct in contact is. Er kunnen gemakkelijk lagen toegevoegd of verwijderd worden en elke laag heeft zijn eigen verantwoordelijkheid, daardoor krijgen we een seperation of concerns. Dit maak ook de encapsulatie van legacy services mogelijk.
...
Over de concepten van Artificiële Intelligentie (AI) en Large Language Models (LLMs) zal ik nu nog niet verder uitweiden. Eerst een toespitsing op Agents.
...
Voor het maken van mijn eigen AI agent zal ik in de daaropvolgende fase onderzoeken welke AI model ik zal gebruiken, de mogelijke security risico's en kosten die erbij komen kijken. Hier zal ik ook heel wat onderzoek doen onder andere over agentic design patronen, MCP \& RAG. Daarenboven zal ik ook onderzoeken in welke ta(a)l(en) en framework(s) ik de proof of concept zal uitwerken.
...
Uiteindelijk zal het correct werken van de verschillende functionaliteiten van de agent worden getoetst. Daarna zal
