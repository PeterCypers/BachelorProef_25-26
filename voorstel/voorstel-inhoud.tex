...
De onderzoeksvraag vanuit mijn stagebedrijf IT1 luidt als volgt: \emph{Hoe kan een AI agent bijdragen aan het ondersteunen van het ontwikkel- en testproces van RESTful APIs binnen een agile softwareontwikkeltraject?} 
...
Toch even LLMs in het kort: Een gesimplificeerde omschrijving zou zijn dat een \textbf{LLM} een zeer sterke autocomplete machine is dat een bepaalde hoeveelheid trainings-data verwerkt heeft om op een input te kunnen reageren gebruik makend van dat uitgebreide arsenaal aan informatie en tracht een zo nauwkeurig mogelijk antwoord als een puzzel samen te stellen en dan terug te sturen als response.
...
\subsubsection{RAG}
Vöör Anthropic MCP introduceerden hadden we RAG (Retrieval-Augmented Generation) van Facebook.
