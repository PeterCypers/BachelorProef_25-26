...
\subsection{Ollama Lokaal (offline) resultaten}
...
\subsection{Ollama Cloud-Signin (online) resultaten}
...
\subsection{Ollama Cloud-API (online) resultaten}
...
\subsection{Ollama AsyncClient (offline) resultaten}
...
\subsection{Ollama Async Generator (offline) resultaten}
...
\subsection{Ollama Img Async Generator (offline) resultaten}
...
\subsection{Ollama Localhost-API Img (offline) resultaten}
...
\subsubsection{Ollama + Tools (offline) resultaten}

Zie: \ref{sssec:ollamaplustools}

\subsubsection{Ollama + JavaScript (offline) resultaten}
