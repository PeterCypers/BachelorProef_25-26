...
\todo{write an intro and explain code for this segment}
...
\textbf{Uitleg bij de code:} %todo ... explain section by section, but keep it all after all code fragments (here) maybe break it up into logical paragraphs
