...
Er wordt een initiele poging gedaan om de Open Api Specification (OAS) als document in te laden en met een langchain\_community package dat toelaat informatie vanop een website op te halen. De structuur van deze ingeladen document wordt vervolgens onder de loep genomen.
...
Deze demo maakt ook gebruik van het Generator $\rightarrow$ Evaluator (ook wel Generator $\rightarrow$ Optimizer) patroon, zie sectie: \ref{sssec:evaluatoroptimizerpattern}. De normale uitvoer staat in de main() functie in commentaar en de uitgebreide informatie wordt uitgeprint in de terminal. Vervolgens bekijken we de demo-code en uitleg bij de code:
