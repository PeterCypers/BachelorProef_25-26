...
%todo: consider rewriteing, bewering zonder staving...
Mensen grijpen steeds vaker naar AI-tools om hun werk te versnellen of verschillende soorten visuele media te produceren.
Het aanbod van generatieve AI tools, geïntegreerde chatbots, AI-agents, codeer-assistenten, tekstbewerkingstools, noem maar op, deze lijst blijft zich steeds verder uit te breiden. Om Een niet exhaustieve reeks van voorbeelden op te noemen:
genereren van: 
tekst met ChatGPT/Google Gemini
beelden met DALL-E/Midjourney
video's met Synthesia
code met Copilot/AlphaCode
...
\begin{figure}[H]
    ...
    \caption[Stackoverflow posts grafiek]{\label{fig:stackoverflowpostsdecline}Het aantal posts op StackOverflow vanaf de website opstart tot op heden.}
\end{figure}
...
De creativiteit van AI generatie komt van: GANs (Generative Adversarial Networks) / VAEs (Variational Auto-encoders) / Transformers / Diffusion models. Deze hebben de evolutie van AI versneld en geleid tot het ontstaan van foundation modellen, deze zijn AI modellen met heel algemene toepassingsmogelijkheden. Deze kunnen aangepast worden om te dienen als tools voor specifieke use-cases. Een onderdeel van foundation modellen zijn LLM's (Large Language Models).
...
We delven niet te ver in details, maar het is zinvol om enkele kenmerken van LLMs te bespreken.
